...
const NavList = [
    ...
    {titre: 'Ressources', url: '/Fournisseur', dropdown: true, subItems: [
        ...
        { subTitre: 'Salle de formation', subUrl: '/Salle' },
            ...
            <div className="relative inline-flex justify-between w-full h-6">
                <div className="inline-flex gap-2 items-center">
                    ...
                    <div className="inline-flex gap-2 items-center rounded-lg px-2 py-2 transition duration-300">
                        <p className="text-xs text-[#b37f2b] px-4 py-1 bg-yellow-100 rounded-full">Organisme de formation :</p>
                        <Link to="#"
                        className="text-xs text-gray-700 font-semibold cursor-pointer hover:underline hover:text-gray-800 transition duration-200">NUMERIKA</Link>
                    </div>
                </div>
